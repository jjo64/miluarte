...
const animasSketch = "https://res.cloudinary.com/doznr2qm4/image/upload/miluarte/archivo/Captura_de_pantalla_2026-06-19_004226_kbbzwm.png";
const animasFinal  = "https://res.cloudinary.com/doznr2qm4/image/upload/miluarte/archivo/Captura_de_pantalla_2026-06-19_004056_lpcimv.png";
...
function FeaturedProject() {
  ...
  return (
    <section style={{ backgroundColor: C.dark, padding: "80px 0", borderTop: "1px solid rgba(255,255,255,0.05)" }} id="proyecto-destacado">
      ...
      >
        <img
          src={getOptimizedImageUrl(t("featured.image") || "https://res.cloudinary.com/doznr2qm4/image/upload/miluarte/diggin/Doke_Red_Flag_u1njsw.jpg", 1200)}
